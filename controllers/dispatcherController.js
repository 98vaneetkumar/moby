...
module.exports = {
  mainpage: async (req, res) => {
    if (req.session.user) return res.redirect("/dispatcher/dispatcher_dashboard");
    res.render("dispatcher_admin/mainpage", {
      layout: false,
      msg: req.flash("msg"),
    });
  },

  dispatcher_dashboard: async (req, res) => {
    if (!req.session.user) return res.redirect("/dispatcher/dispatcher");
    res.render("dispatcher_admin/dashboard", { user: req.session.user });
  },

  homepage: async (req, res) => {
    res.render("dispatcher_admin/home", { user: req.session.user });
  },

  ridehistory: async (req, res) => {
    res.render("dispatcher_admin/ridehistory", { user: req.session.user });
  },

  activerides: async (req, res) => {
    res.render("dispatcher_admin/activerides", { user: req.session.user });
  },
  ...
  userprofile: async (req, res) => {
    res.render("dispatcher_admin/userprofile", { user: req.session.user });
  },
  ...
  resetPassword: async (req, res) => {
    try {
      let data = req.user;
      res.render("dispatcher_admin/changePassword", { data: data });
    } catch (error) {
  ...
  forgotChangePassword: async (req, res) => {
    try {
      ...
      return res.render("dispatcher_admin/successPassword", {
